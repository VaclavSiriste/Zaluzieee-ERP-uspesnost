...
pokladamee: sloupec U (Kraj) + sloupec P (Datum zaměření) ve zvoleném měsíci.`,
  ...
  filter_obdobi: `Období filtru platí pro SLA příchozích linek (Daktela), Výčet SLA (ERP / OVT sheet dle značky), úspěšnost navolání i průměrnou dobu do navolání zmeškaných. U sheetu poptávky = datum přijetí leadu (B). Vlastní datum = celé kalendářní dny Europe/Prague. Targety používají kalendářní měsíc zvlášť.`,
...
OVT sheet (pokladamee / malujemeee): dnešek (Praha) · A=ID · B=datum přijetí · K=datum navolání.
Poptávky / SLA 24·48·72: filtr období na datum přijetí leadu (B).`,

  vycet_sla_leads: `ERP: počet leadů s business datem ve filtru.
Sheet: leady s datem přijetí (B) = dnešek a vyplněným ID (A).`,

  vycet_sla_navolano: `ERP: lead navolán ve stejný business den (first_iframe_change_at).
Sheet: dnes přijatý lead (B) má vyplněné datum navolání (K).`,

  vycet_sla_missing: `Přišlo leadů minus dnes navoláno.
Sheet: B = dnešek a K je prázdné.`,
