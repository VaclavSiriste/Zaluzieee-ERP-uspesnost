...
Stejná logika ERP jako u souhrnu, filtr podle jména operátora.`,
  ...
  trasovani_uspesnost: `Úspěšnost trasování = (Naplánován termín zaměření ANO) / (Dopadl hovor ANO) × 100 %.
Jen zaluzieee CZ · organization_id = 5.
Čitatel: slug naplanovan_termin_zamereni = ANO (assignment kdo_naplanoval_zamereni).
Jmenovatel: slug dopadl_hovor = ANO (assignment domluvil_zamereni).
Období: datum navolání. Vyloučeno: status duplikace.`,

  trasovani_operator: `Úspěšnost trasování operátora = jeho Naplánován termín zaměření ANO / Dopadl hovor ANO × 100 %.
Stejná logika ERP jako u souhrnu (organizace 5).`,
...
Stejný vzorek leadů s reakcí ve filtru období.`,
  ...
  trasovac_sla12: `SLA 12 = odbaveno do 12 h / odbavené ve filtru × 100 %.
Odbaveno = první změna v audit logu ≥ 15 min po nastavení statusu ceka-na-trasovace a doba ≤ 12 h.
Období filtru: datum nastavení stavu. Stejná logika jako průměrná doba.`,

  trasovac_sla24: `SLA 24 = odbaveno do 24 h / odbavené ve filtru × 100 %. Stejný start/konec jako SLA 12.`,

  trasovac_sla36: `SLA 36 = odbaveno do 36 h / odbavené ve filtru × 100 %. Stejný start/konec jako SLA 12.`,

  trasovac_duvod: `Rozpad aktuální fronty „Čeká na trasovače“ podle ERP sloupce Důvod ne (slug proc_nedopadl_hovor).
„Bez důvodu ne“ = sloupec prázdný nebo nevyplněný.
Ostatní hodnoty: 1×/2×/3× nedovoláno, Volat později, …
Kliknutím na počet otevřete seznam leadů s daným důvodem.
Snapshot — nezávisí na filtru období.`
}
