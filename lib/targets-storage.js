...
function emptyMonthBucket(brandId = 'cz') {
  const useSheetTechs = resolveTargetsBrandId(brandId) === 'pokladamee'
...
function normalizeMonthBucket(raw, brandId = 'cz') {
  ...
  // pokladamee: prázdný katalog dokud nenačteme sheet (ne fallback na ERP jména)
  if (resolveTargetsBrandId(brandId) === 'pokladamee') {
