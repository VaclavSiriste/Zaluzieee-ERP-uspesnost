...
export const OPERATIONS_BRANDS = {
  ...
  pokladamee: {
    ...
    /** Úspěšnost + jména techniků z Google Sheet OVT (Databáze_2026) */
    navolaniSource: 'ovt-sheet',
    navolaniHint:
      'OVT sheet · gid 1262379590 · Dopadl hovor ANO (sloupec L) / počet řádků · filtr: datum navolání (sloupec K)',
